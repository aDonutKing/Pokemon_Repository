...
class InventoryPanel extends JPanel
{
    ...
    public InventoryPanel(GameLauncher game)
    {
        ...
        // Money counter — top-left of the header
        moneyLabel = new JLabel("$" + GameLauncher.money);
        moneyLabel.setForeground(Color.YELLOW);
        moneyLabel.setFont(new Font("Monospaced", Font.BOLD, 18));
    ...
    public void refresh()
    {
        moneyLabel.setText("$" + GameLauncher.money);
        listModel.clear();
